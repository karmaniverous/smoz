...
- chore: add npm-pack-check CI workflow [`#1`](https://github.com/karmaniverous/smoz/pull/1)
- cleanup [`41e360d`](https://github.com/karmaniverous/smoz/commit/41e360db09d1dc63987fbc5c503c5e05570d5b67)
- updated get-dotenv [`0c32d46`](https://github.com/karmaniverous/smoz/commit/0c32d46a86f8c6ede0a330537f1fc3569e506310)
- imports [`f0e466d`](https://github.com/karmaniverous/smoz/commit/f0e466dfd69f35302e03595d25bca9aac8aba95a)
- chore: add get-dotenv interop note and log in plan [`63a3064`](https://github.com/karmaniverous/smoz/commit/63a3064705e961091e6ab19cd9dadc1afcbf8ec9)
- chore: exclude .stan from tools, fix test typing and lint [`a589c8c`](https://github.com/karmaniverous/smoz/commit/a589c8cb53e2a3058217efd749871ced326495d8)
- docs: split requirements from project prompt [`c29861a`](https://github.com/karmaniverous/smoz/commit/c29861a79a6b60d60061f34ee192afd0cb8a353c)
- updated dependencies [`684daa8`](https://github.com/karmaniverous/smoz/commit/684daa853df1c819be20432c26fc525d2f2da1c8)
- chore: add facets for tests/docs/templates/examples/diagrams/vscode/ci [`9380e03`](https://github.com/karmaniverous/smoz/commit/9380e0312e6fcdf9b0c4d17ac6b2d6b7bcaf7668)
- updated requirements & dev plan [`0c0901e`](https://github.com/karmaniverous/smoz/commit/0c0901e879ba3c7126607ff73467442cf19314e9)
- interop [`1860363`](https://github.com/karmaniverous/smoz/commit/1860363769e942680cc3c9d25452e083dd184e47)
- updated docs [`ef4bfb6`](https://github.com/karmaniverous/smoz/commit/ef4bfb65f8e0f4b0139139020c6671a54a70bc8d)
- updated docs [`1fe222d`](https://github.com/karmaniverous/smoz/commit/1fe222da427d292e26eaed5ee5703c0226e47ba6)
- updated docs [`a8c27fd`](https://github.com/karmaniverous/smoz/commit/a8c27fddfa7fb4ffbc1eadee0c34edf3aa8fbf5f)
- updated docs [`6485aba`](https://github.com/karmaniverous/smoz/commit/6485aba66370634a592399688d3e296bbb4f456f)
- refactor(cli): remove spawn-env wrapper; call get-dotenv directly [`8343929`](https://github.com/karmaniverous/smoz/commit/834392960fd72fc2d2259dd7853601ec2ab99526)
- feat(cli): replace Commander with minimal get-dotenv–aware bootstrap [`d8d1d97`](https://github.com/karmaniverous/smoz/commit/d8d1d97317cfc237055ebdff3bebce515641a809)
- feat(cli): move to GetDotenvCli host; drop adapter; keep aws plugin [`d7873b1`](https://github.com/karmaniverous/smoz/commit/d7873b12912b0850e772f53ceb1ee0bbd5bd374d)
- feat(cli): build host with GetDotenvCli and smoz plugin [`207022d`](https://github.com/karmaniverous/smoz/commit/207022ddd8992206b0245494ad578b3f822088ab)
- installed getdotenv [`3da9684`](https://github.com/karmaniverous/smoz/commit/3da9684bbb44c9d9269013e78de2f30d7ed1c10f)
- docs: add getdotenv interop design note and update plan [`8fcdcc6`](https://github.com/karmaniverous/smoz/commit/8fcdcc65588fc75e9952edfef691043bbeb937c9)
- feat(cli): route all commands through get-dotenv host only [`acfa89c`](https://github.com/karmaniverous/smoz/commit/acfa89cb9f728598890c5656d8136bc36c1ed9dc)
- interop [`f1eb124`](https://github.com/karmaniverous/smoz/commit/f1eb124e90a0cd8eaffad97e27fd622dd80f5624)
- docs: add get-dotenv ownership alert; interop note on cliHost types [`50093fd`](https://github.com/karmaniverous/smoz/commit/50093fd03a207c8f3db041ae4cbe8c618a37c204)
- feat(cli): register smoz commands on get-dotenv host [`e13b332`](https://github.com/karmaniverous/smoz/commit/e13b332a4618d85bbb204c6014ca78b58cd380b0)
- docs: add interop note for DDB CLI local orchestration [`93b7707`](https://github.com/karmaniverous/smoz/commit/93b77076332abb60df34d1368a0dd34e06378c07)
- docs(interop): record get-dotenv TS2379 identity and missing buildSpawnEnv export [`51eb004`](https://github.com/karmaniverous/smoz/commit/51eb0048d38c2f45557c5fe13fd816ad83345f42)
- docs: prune and refactor dev plan (stan.todo) [`dc97ff8`](https://github.com/karmaniverous/smoz/commit/dc97ff8e1d56c96ce1c206a8a7567fe38a1231f5)
- feat(dev): stage precedence + offline spawn-env normalization [`d0e3450`](https://github.com/karmaniverous/smoz/commit/d0e3450dea42f6b67f584b394e92e0378dcd8654)
- chore(cli): add get-dotenv host skeleton and opt-in switch [`951a9dc`](https://github.com/karmaniverous/smoz/commit/951a9dc3ae57847a5abff39b5fd60a75647df6f4)
- fix(cli): harden host command plugin and test typings [`decfa2f`](https://github.com/karmaniverous/smoz/commit/decfa2fe5e882315e37f9c25f46abe449c96af36)
- feat(cli): delegate `cmd`/`batch` to get-dotenv plugin-first host [`9e37738`](https://github.com/karmaniverous/smoz/commit/9e3773847e97467a603bc01ef36812a8ede58305)
- feat(cli): adopt spawn-env normalization (first pass) and remove ambient `any` [`88af76f`](https://github.com/karmaniverous/smoz/commit/88af76f252e0c09d4c22a4a6455b2470dd167a90)
- fix(cli): expand get-dotenv host adapter export probes [`99d8807`](https://github.com/karmaniverous/smoz/commit/99d8807988d769948b7971859f76d641ff7c1fc7)
...
- refactor(cli): replace dynamic import in spawnEnv with static import [`ebd5b24`](https://github.com/karmaniverous/smoz/commit/ebd5b246baa46e4231b63671814270d608bba8ba)
- facets [`5981e1b`](https://github.com/karmaniverous/smoz/commit/5981e1b5f80b37dc8ff41cdf4cb6f0eb3750deaf)
- test(cli/host): add opt-in host tests for createCli/fallback paths [`ae2ad50`](https://github.com/karmaniverous/smoz/commit/ae2ad5063d1150ac53e4cedcc52db51a674a9340)
- feat(cli/host): prefer createCli host (attach smoz placeholder); fallback to adapter [`183e633`](https://github.com/karmaniverous/smoz/commit/183e633fc11a935d9abd1da48eda9a1bb414a9d6)
- refactor stan config [`188ebc6`](https://github.com/karmaniverous/smoz/commit/188ebc68fa6c41f816b442588a132b6a3d31ae3c)
- seed STAGE_NAME param in default template [`90fa81f`](https://github.com/karmaniverous/smoz/commit/90fa81f4a389323b57061846094aa0ef9bf68785)
- fix: address copilot review — require local prettier, surface spawn errors (#4) [`72ff791`](https://github.com/karmaniverous/smoz/commit/72ff79117e5526e7cf2b450b5ed9c1d26d4bfc9a)
- fix(cli): omit undefined branding in get-dotenv host adapter [`f6e66db`](https://github.com/karmaniverous/smoz/commit/f6e66db2976c3d6e2d9259307dc9a0b1bf7b0736)
- chore: replace z.any() placeholders with z.unknown() [`333106d`](https://github.com/karmaniverous/smoz/commit/333106d67f67b6a5b49e47588a79a757053f0afc)
- fix(cli): bind host methods in plugin to preserve `this` [`07dd73a`](https://github.com/karmaniverous/smoz/commit/07dd73a785d8703a39750c5c90d06eab7dd4c9dd)
- docs(prompt): add get‑dotenv docs‑first policy to project prompt [`203bc25`](https://github.com/karmaniverous/smoz/commit/203bc25ba0512b4c63780777b40f0a128e0a1105)
- test(cli/host): fix opt-in host mocks; lint cleanup [`e140356`](https://github.com/karmaniverous/smoz/commit/e140356e4b34fa0556ad9402ce1924a7dbd62461)
- updated getdotenv [`d1d97e0`](https://github.com/karmaniverous/smoz/commit/d1d97e034593b1d3cd8ce384e55bab70d514d75f)
- fix(cli): hard-fail when host unavailable (process.exit) [`1e8005c`](https://github.com/karmaniverous/smoz/commit/1e8005cef8bdd0bb054421cef6db2db858ff4f54)
- feat(cli): require get-dotenv host; remove fallbacks [`bfc2acf`](https://github.com/karmaniverous/smoz/commit/bfc2acfa32dbf0b12a0543e5d886ddb70fcb011f)
- chore(cli): remove duplicate default export from smoz plugin [`81dce26`](https://github.com/karmaniverous/smoz/commit/81dce2679e4e34ff263f5d1301b2326ca54ab608)
- chore: add npm publish safety net (.npmignore + gitignore *.local) [`8579ac0`](https://github.com/karmaniverous/smoz/commit/8579ac0a9f2a53383471a5b1078a46cf644a11f8)
- chore(cli): reference smoz plugin skeleton to satisfy knip [`28b2303`](https://github.com/karmaniverous/smoz/commit/28b2303bfe9ac90cc26a26cb8ecf2b772c5cb46c)
- use package ts version [`5271454`](https://github.com/karmaniverous/smoz/commit/527145407456a2026b318a59df45dd41a62af9f0)
- chore: remove register from package script (#4) [`25d9121`](https://github.com/karmaniverous/smoz/commit/25d9121cad7860756badae1ccbcb2c5f81c9be72)
- seed STAGE_NAME param in default template [`76d44f5`](https://github.com/karmaniverous/smoz/commit/76d44f51645353e02d1083641f55ed3f468a381f)
- use package ts version [`e69d3fe`](https://github.com/karmaniverous/smoz/commit/e69d3fe4c1ed7a59807ac08f9f36e6bbbfb118b6)
- version update [`92e7c0f`](https://github.com/karmaniverous/smoz/commit/92e7c0f0c82d58a9f3d473de70f8f6f58a410c27)

#### [0.2.10](https://github.com/karmaniverous/smoz/compare/0.2.9...0.2.10)

> 15 September 2025

- chore: release v0.2.10 [`b1c0dfb`](https://github.com/karmaniverous/smoz/commit/b1c0dfbb7dd38e47001a2807ebfec83777dc656b)
